...
public class WaveLoadingViewHolder {
    ...
    public WaveLoadingViewHolder(Context context, Bookshelf bookshelf) {
    ...
    private void initViews(){
        mContentView = LayoutInflater.from(mContext).inflate(R.layout.item_wave_loading_view, null, false);
