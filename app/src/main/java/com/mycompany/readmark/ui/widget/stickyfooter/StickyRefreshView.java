package com.mycompany.readmark.ui.widget.stickyfooter;
...
public class StickyRefreshView extends View {
    ...
    public StickyRefreshView(Context context) {
        this(context, null);
    }

    public StickyRefreshView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StickyRefreshView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initSize() {
        mEdge = DensityUtils.dp2px(getContext(), 5);
        mRotateDrawableSize = DensityUtils.dp2px(getContext(), 30);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (mIsRotating) {
            ...
            canvas.rotate(mCurrentDegree
                    , mRotateDrawable.getBounds().centerX()
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationStart(Animator animation) {
                ...
                if (mCurrentBottomHeight != 0) {
                    //startChangeWholeHeaderViewPaddingTop(mCurrentBottomHeight);
                } else {
                    //startChangeWholeHeaderViewPaddingTop(-(mTopSize + getPaddingTop() + getPaddingBottom()));
                }
            }
