...
public class MTSecondView extends View {
    private Bitmap endBitmap;

    public MTSecondView(Context context) {
        this(context, null);
    }

    public MTSecondView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MTSecondView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public MTSecondView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
